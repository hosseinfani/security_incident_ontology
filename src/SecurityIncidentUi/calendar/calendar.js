...
function tc_setDay(objname, dvalue, fireEvent){
	var obj = document.getElementById(objname);
	...
	//calling calendar_onchanged script
	if(document.getElementById(objname+"_och").value != "" && changed && (fireEvent==null || fireEvent == true)) calendar_onchange(objname);
}

function tc_setMonth(objname, mvalue, fireEvent){
	var obj = document.getElementById(objname);
	var date_array = obj.value.split("-");
...
function tc_setYear(objname, yvalue, fireEvent){
	var obj = document.getElementById(objname);
	var date_array = obj.value.split("-");
